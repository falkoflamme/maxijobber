  ...
  return (
    <div className="min-h-screen bg-[#F5F4F0]">
      ...
      <div className="max-w-2xl mx-auto px-6 py-10">
        ...
        {/* Hero card */}
        <div className="bg-white border-2 border-[#1a1a1a] p-8 mb-6" style={{ boxShadow: '4px 4px 0px #1a1a1a' }}>
        ...
        <div className="bg-white border-2 border-[#1a1a1a] p-6 mb-6" style={{ boxShadow: '4px 4px 0px #1a1a1a' }}>
          <h2 className="text-xs font-black uppercase tracking-widest text-gray-400 mb-5">Direkt Kontakt aufnehmen</h2>
          <div className="space-y-3">
            {profile.whatsapp && (
              <a
                ...
                className="flex items-center justify-center gap-2 w-full py-4 font-black bg-green-500 text-white hover:bg-green-600 transition text-sm border-2 border-[#1a1a1a] uppercase tracking-widest"
              >
            ...
            {profile.phone && (
              <a
                ...
                className="flex items-center justify-center gap-2 w-full py-4 font-black bg-gray-900 text-white hover:bg-gray-700 transition text-sm border-2 border-[#1a1a1a] uppercase tracking-widest"
              >
            ...
            {profile.email && (
              <a
                ...
                className="flex items-center justify-center gap-2 w-full py-4 font-black border-2 border-[#1a1a1a] hover:bg-gray-900 hover:text-white transition text-sm uppercase tracking-widest"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {profile.bio && (
          <div className="bg-white border-2 border-[#1a1a1a] p-6 mb-6">
            <h2 className="text-xs font-black uppercase tracking-widest text-gray-400 mb-4">Über mich</h2>
          ...
          <div className="bg-white border-2 border-[#1a1a1a] p-6 mb-6">
            ...
            <div className="flex flex-wrap gap-2">
              {profile.skills.map((skill: string) => (
                <span key={skill} className="px-4 py-2 bg-gray-50 border-2 border-gray-200 text-sm font-bold">
                  {skill}
                </span>
              ))}
            </div>
