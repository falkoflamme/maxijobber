    ...
    <div className="min-h-screen bg-[#F5F4F0]">
      ...
      <div className="max-w-4xl mx-auto px-6 py-10 space-y-8">
        ...
        <div className="pt-4 border-t border-gray-200 flex items-center justify-between">
          <a href="/unternehmen/einrichten" className="text-xs font-semibold text-gray-400 hover:text-gray-900 transition">
            Firmenprofil bearbeiten
          </a>
          <form action="/auth/signout" method="POST">
            <button type="submit" className="text-xs font-semibold text-gray-400 hover:text-gray-900 transition">
              Abmelden
            </button>
          </form>
        </div>
